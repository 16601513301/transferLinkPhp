...
class CombinedAuthMiddleware implements Middleware
{
    ...
    public function handle(Request $request, callable $next): Response
    {
        ...
        $user = $this->tryUserApiTokenAuth($request);
     ...
     */
    private function tryUserApiTokenAuth(Request $request): ?array
    {
        $authHeader = null;
        ...
        try {
            ...
            if (!$tokenModel instanceof UserApiToken || $tokenModel->isExpired()) {
                return null;
            }
